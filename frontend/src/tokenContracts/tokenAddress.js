...
export const ARBITRUM_TOKEN_ADDRESS = [
  ...
  },
  {
    ...
    abi: [
      ...
      {
        inputs: [
          { internalType: "uint256", name: "_mint_cap", type: "uint256" },
        ],
        name: "setMintCap",
        outputs: [],
        stateMutability: "nonpayable",
      ...
      {
        inputs: [
          { internalType: "address", name: "new_timelock", type: "address" },
        ],
        name: "setTimelock",
        outputs: [],
        stateMutability: "nonpayable",
      ...
      {
        inputs: [
          { internalType: "address", name: "the_address", type: "address" },
        ],
...
export const OPTIMISM_TOKEN_ADDRESS = [
  {
    name: "USDT",
  ...
  },
  {
    ...
    abi: [
      {
        inputs: [
          { internalType: "address", name: "l2BridgeAddr", type: "address" },
          { internalType: "address", name: "l1TokenAddr", type: "address" },
        ],
        stateMutability: "nonpayable",
        type: "constructor",
      },
  ...
  },
  {
    ...
    abi: [
      ...
      },
      {
        ...
        name: "target",
        outputs: [
          { internalType: "contract Proxyable", name: "", type: "address" },
        ],
        payable: false,
        stateMutability: "view",
        type: "function",
